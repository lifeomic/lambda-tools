...
export function useKinesisDocker (anyTest: TestInterface, useUniqueStreams?: boolean): void {
...
export function useKinesis (anyTest: TestInterface, streamName: string): void {
